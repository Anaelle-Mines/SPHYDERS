...
def get_capa_woSMR_REinf(areaList=['Marseille'],yearList=['2020','2030','2040','2050'],y_act='middle',CCS=50):
                ...
                pd.DataFrame(
                    data={
                        tech: {
                            ...
                            "Category": "Electricity production",
                            "lifeSpan": lifespan,
                            "powerCost": (1.71 if CCS==10 else 7.71),
                            "investCost": capex,
                            "operationCost": opex,
                            "minInstallCapacity": 0,
                ...
                pd.DataFrame(
                    data={
                        tech: {
                            ...
                            "Category": "Electricity production",
                            "lifeSpan": lifespan,
                            "powerCost": (2.9 if CCS==10 else 13.7),
                            "investCost": capex,
                            "operationCost": opex,
                            "minInstallCapacity": 0,
                            "maxInstallCapacity": 100000,
...
def get_capa_woSMR(areaList=['Marseille'],yearList=['2020','2030','2040','2050'],y_act='middle',CCS=50):
